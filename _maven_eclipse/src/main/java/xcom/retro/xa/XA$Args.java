...
@Log
public class XA$Args extends CLArgs {
	...
	public static final Option ArgOption_Binary =
			Option.builder(Arg_Binary).argName("file").longOpt(ArgLong_Binary).hasArg().optionalArg(true).desc("generate assembly binary").build() ;

	public static final String Arg_Format = "f" ;
	public static final String ArgLong_Format = "format" ;
	public static final Option ArgOption_Format =
			Option.builder(Arg_Format).longOpt(ArgLong_Format).argName("format").hasArg().optionalArg(true).desc("binray format").build() ;

	public static final String Arg_List = "l" ;
	public static final String ArgLong_List = "list" ;
	public static final Option ArgOption_List =
			Option.builder(Arg_List).longOpt(ArgLong_List).argName("file").hasArg().optionalArg(true).desc("generate assembly listing").build() ;

	public static final String Arg_XRef = "x" ;
	public static final String ArgLong_XRef = "xref" ;
	public static final Option ArgOption_XRef =
			Option.builder(Arg_XRef).argName("file").longOpt(ArgLong_XRef).hasArg().optionalArg(true).desc("generate cross reference listing").build() ;

	public static final String Arg_Processor = "p" ;
	public static final String ArgLong_Processor = "proc" ;
	public static final Option ArgOption_Processor =
			Option.builder(Arg_Processor).longOpt(ArgLong_Processor).argName("processor").hasArg().desc("processor").build() ;
	...
	public XA$Args(CommandLine cmd, Properties props, String[] args, Map<String, Object> decodedArgs) {
		super(cmd, props, args,decodedArgs) ;
	}
