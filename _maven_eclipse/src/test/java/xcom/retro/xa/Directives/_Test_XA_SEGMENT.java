...
public class _Test_XA_SEGMENT {
	...
	private static final Logger Logger = LoggerFactory.getLogger(_Test_XA_SEGMENT.class) ;

	String desc ;
	String srcFSpec ;


	public _Test_XA_SEGMENT(final String desc, final String srcFSpec) {
