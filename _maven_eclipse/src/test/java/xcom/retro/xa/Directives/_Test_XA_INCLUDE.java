...
public class _Test_XA_INCLUDE {
	...
	private static final Logger Logger = LoggerFactory.getLogger(_Test_XA_INCLUDE.class) ;

	String desc ;
	String srcFSpec ;


	public _Test_XA_INCLUDE(final String desc, final String srcFSpec) {
